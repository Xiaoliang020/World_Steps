...
public class EventConsumer  {
    ...
    @KafkaListener(topics = {EntityTypeConstant.TOPIC_COMMENT, EntityTypeConstant.TOPIC_LIKE, EntityTypeConstant.TOPIC_FOLLOW})
    public void handleCommentMessage(ConsumerRecord record) {
        ...
        message.setFromId(EntityTypeConstant.SYSTEM_USER_ID);
